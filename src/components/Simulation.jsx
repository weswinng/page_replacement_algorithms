...
const Simulation = () => {
  ...
  return (
    <section className='flex flex-col justify-center items-center font-primary'>
      <div className='flex flex-row flex-wrap justify-center gap-10 border-primary border-1 w-fit rounded-2xl p-4 m-4 shadow-2xl shadow-primary-shadow bg-background'>
